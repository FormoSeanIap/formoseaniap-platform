---
id: using-nginx-as-load-balancer-with-node-js-express
lang: en
title: "Using Nginx as Load Balancer with Node.js (Express)"
slug: using-nginx-as-load-balancer-with-node-js-express
excerpt: "In this article, I introduce the basic idea of load balancing with Nginx."
category: technical
tags:
  - technical
  - architecture
...
![Weighted Load Balancing](./weighted_load_balancing.png "**Weighted Load Balancing**")

- Definition: to distribute request based on the weights on server.

![Least Load(Connections) Balancing](./least_load_connections_balancing.png "**Least Load(Connections) Balancing**")
...
![Without hash balancing](./image-06.png "Without hash balancing")

![With hash balancing](./image-07.png "With hash balancing")
...
1. Clone files from: [FormoSeanIap/nginx-test (github.com)](https://github.com/FormoSeanIap/nginx-test)
2. Do npm install
...
[Embedded media](https://www.youtube.com/embed/6ZtuXxUyYc8?feature=oembed)
...
[Embedded media](https://www.youtube.com/embed/UY24fK4DJvQ?feature=oembed)
...
[Embedded media](https://www.youtube.com/embed/qDMIzI267HY?feature=oembed)
...
[Embedded media](https://www.youtube.com/embed/rGSqCe-poWE?feature=oembed)
...
[Embedded media](https://www.youtube.com/embed/cbuFqnhVyf0?feature=oembed)
...
[Embedded media](https://www.youtube.com/embed/MyH7rME_8Ng?feature=oembed)
